...
// Este repositório = plano de 1 Mês por R$ 20,00.
// (O repo flopgames2 usa os valores do plano de 3 Meses por R$ 40,00.)
const PLAN = {
  amount_cents: 2000,
  price_now: '20,00',        // exibido após o "R$"
  price_per: '/ mês',
  old_price: 'de R$ 76,90',  // âncora riscada
  plan_badge: '1 MÊS',       // selo do card + linha do título
  duration_label: '1 Mês',
  plan_name: 'Game Pass Ultimate — 1 Mês'
};
